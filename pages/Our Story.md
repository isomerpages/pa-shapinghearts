...
<section>
  ...
  <div class="canvass">
    <div class="faqs_left">
      ...
      <br>
      <img src="https://i.ibb.co/F6zc2zJ/Homepage-3.png" style="width: 500px" class="mt-5" alt="Event">
    </div>
    <div class="faqs_right">
      <div class="faq-container">
        <div class="faq">
          <input type="checkbox" id="faq1" class="faq-input">
          <label for="faq1" class="faq-question">Add commonly asked questions here</label>
        ...
        <div class="faq">
          ...
          <label for="faq2" class="faq-question">Add commonly asked questions here</label>
          <div class="faq-answer">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lorem qui Nullam ut lorem qui.
          </div>
        </div>
        <div class="faq">
          ...
          <label for="faq3" class="faq-question">Add commonly asked questions here</label>
          <div class="faq-answer">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut lorem qui Nullam ut lorem qui.
          </div>
        </div>
